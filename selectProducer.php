        ...
        <table border="0" cellpadding="0" cellspacing="0">
            ...
            <?php
				...
				if ($_REQUEST['action'] == "del") {
                    ...
                    mysql_query("DELETE FROM Producer WHERE name='$name'");
                }
                ...
                while ($row = mysql_fetch_array($result)) {
                    ...
                    echo "<td><a onclick=\"return confirm('Are you sure?');\" href='selectProducer.php?action=del&amp;name=".$row['name']."&amp;title=".$title."&amp;year=".$year."&amp;type=".$type."&amp;producer_name=".$row['name']."'><span class='red'>Delete</span></a></td>";
					echo "<td><a href='selectSupplier.php?title=".$title."&amp;year=".$year."&amp;type=".$type."&amp;producer_name=".$row['name']."'><span class='red'>Select</span></a></td>";
                    echo "</td>";
                    echo "</tr>";
                    $i++;
                }
