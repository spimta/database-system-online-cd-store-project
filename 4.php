    ...
    <body>
        ...
        <table border="0" cellpadding="0" cellspacing="0">
            <tr bgcolor="#f87820">
                ...
                <td class=tabhead><img src="img/blank.gif" alt="" width="200" height="6"><br><b>Starting Date</b></td>
                <td class=tabhead><img src="img/blank.gif" alt="" width="200" height="6"><br><b>Percent discount</b></td>
            ...
            <?php
				...
				if ($_REQUEST['action'] == "del") {
					...
					mysql_query("INSERT INTO Vip (ssn,starting_date,percent_discount) VALUES ('$ssn', '$starting_date', $percent_discount)");
					mysql_query("INSERT INTO Rent (cd_name,ssn,rent_date,period) VALUES('$title','$ssn','$date',$period)");
                }

                $result = mysql_query("SELECT * FROM Vip NATURAL JOIN (SELECT cd_name AS title, ssn FROM Rent)R ORDER BY ssn;");
                ...
                while ($row = mysql_fetch_array($result)) {
                    ...
                    echo "<td>".$row['percent_discount']."</td>";
					echo "<td>".$row['title']."</td>";
                    echo "<td><a onclick=\"return confirm('Are you sure?');\" href='4.php?action=del&amp;ssn=".$row['ssn']."&amp;title=".$row['title']."'><span class='red'>Delete</span></a></td>";
                    echo "</td>";
                    echo "</tr>";
                    $i++;
                }
        ...
        <form action="<?php echo 'rent2.php'; ?>" method="get">
            <table border="0" cellpadding="0" cellspacing="0">
				...
				<tr><td>Starting Date(yyyy-mm-dd):</td><td> <input type="text" size="30" name="starting_date"></td></tr>
				<tr><td>Percent Discount:</td><td> <input type="text" size="30" name="percent_discount"></td></tr>
                <tr><td>&nbsp;</td><td><input type="submit" value="Add VIP"></td></tr>
            </table>
        </form>
